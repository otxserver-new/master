function onSay(cid, words, param)
	...
	if param:find('invite') == 1 and 3 then
		...
		if player == nil or tonumber(minutos) == nil or player == '' or tonumber(minutos) == 0 then
			for i = 1, #status do
				doPlayerSendTextMessage(cid,status[i],"[WAR AREA] Use: !wardara \"invite NOME_DE_UM_MEMBRO_INIMIGO MINUTOS_DE_WAR (EX: !wardara \"invite String 40 - invitar para uma war de 40 minutos)") 
			end
			return false
		end
