...
local function lms()
    broadcastMessage("LMS event will start in 9 minutes. Portal is opened in Event Room [Temple of Thais]. The reward is 2 PREMIUM POINTS, Hurry!!", MESSAGE_STATUS_WARNING)
